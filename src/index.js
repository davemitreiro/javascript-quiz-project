document.addEventListener("DOMContentLoaded", () => {
  ...
  function showQuestion() {
    ...
    [...question.choices].forEach((choice) => {
      const questionItem = document.createElement("input");
      questionItem.setAttribute("type", "radio");
      questionItem.setAttribute("name", "choice");
      questionItem.setAttribute("value", choice);

      const labelItem = document.createElement("label");
      labelItem.appendChild(questionItem);
      labelItem.appendChild(document.createTextNode(choice));

      choiceContainer.appendChild(labelItem);

      const brItem = document.createElement("br");
      choiceContainer.appendChild(brItem);
    });
  }
  ...
  if (quiz.questions[quiz.currentQuestionIndex] === quiz.questions.length - 1) {
    showResults();
  }
